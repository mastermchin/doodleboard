...
export default class DoodleBoard extends LightningElement {
    ...
    handleOptionChange(evt) {
        let option = evt.target.dataset.optionAttr;
        let changedBrushOptions = this.brush.clone();
        changedBrushOptions[option] = evt.target.value;
        this.brush = changedBrushOptions;
        this.setBrushOptions();
    }
}